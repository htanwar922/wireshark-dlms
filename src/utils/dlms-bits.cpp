...
const value_string dlms_service_class_names[] = {
    { 0, "unconfirmed" },
    { 1, "confirmed" },
    { 0, 0 }
};
...
const value_string dlms_priority_names[] = {
    { 0, "normal" },
    { 1, "high" },
    { 0, 0 }
};
...
const value_string dlms_self_descriptive_names[] = {
...
const value_string dlms_processing_option_names[] = {
    { 0, "continue-on-error" },
    { 1, "break-on-error" },
    { 0, 0 }
};
