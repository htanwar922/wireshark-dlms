...
// General APDUs - Himanshu
#define DLMS_GENERAL_GLO_CIPHERING 219
#define DLMS_GENERAL_DED_CIPHERING 220
#define DLMS_GENERAL_CIPHERING 221
#define DLMS_GENERAL_SIGNING 223
#define DLMS_GENERAL_BLOCK_TRANSFER 224
